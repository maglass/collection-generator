...
BASE_COLLECTION_HEADER_FILE_NAME = 'base_collection_header.csv'
BASE_COLLECTION_FILE_NAME = 'base_collection.tsv'
BASE_COLLECTION_SUMMARY_FILE_NAME = 'summary.tsv'

CORPUS_HEADER_NAME = 'corpus_header.csv'
CORPUS_FILE_NAME = 'corpus.tsv'
